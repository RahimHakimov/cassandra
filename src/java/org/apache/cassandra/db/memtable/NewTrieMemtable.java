...
public class NewTrieMemtable extends AbstractShardedMemtable
{
    private static final Logger logger = LoggerFactory.getLogger(NewTrieMemtable.class);
    ...
    NewTrieMemtable(AtomicReference<CommitLogPosition> commitLogLowerBound, TableMetadataRef metadataRef, Owner owner, Integer shardCountOption)
    {
    ...
    static class Factory implements Memtable.Factory
    {
        ...
        public Memtable create(AtomicReference<CommitLogPosition> commitLogLowerBound,
                               ...
                               Owner owner)
        {
            return new NewTrieMemtable(commitLogLowerBound, metadaRef, owner, shardCount);
        }
